...
COLORS = {
    "high_energy_unpleasant": "#FF6F61",
    "high_energy_pleasant": "#FFD700",
    "low_energy_unpleasant": "#87CEFA",
    "low_energy_pleasant": "#98FB98"
}
...
if "selected_mood" not in st.session_state or st.session_state["selected_mood"] not in MOODS:
...
if st.session_state["selected_mood"]:
    ...
    if mood in MOODS:
        ...
        st.warning("⚠️ Unknown mood selection.")
